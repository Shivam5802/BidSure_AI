...
export interface AuditabilityMetrics {
  requirementProvenancePercentage: number;
  evidencePageProvenancePercentage: number;
  evaluationVersionTracePercentage: number;
  auditEventsRecordedCount: number;
  evidenceTraceabilityPercentage: number;
  automationCoveragePercentage: number;
  humanReviewRatePercentage: number;
  verificationCoveragePercentage: number | null;
}
